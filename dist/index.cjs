...
__export(index_exports, {
  ...
  LeoEndpointCX: () => LeoEndpointCX,
  buildHistoricalCycleCandidates: () => buildHistoricalCycleCandidates,
  buildKardexEndpointCandidates: () => buildKardexEndpointCandidates,
  createLeoClient: () => createLeoClient,
  cycleVariants: () => cycleVariants,
  getStudentCard: () => getStudentCard,
  loginWithPem: () => loginWithPem,
...
function createIss(privateKey) {
  return import_jsonwebtoken.default.sign({}, privateKey, {
    algorithm: "RS256",
    expiresIn: 60,
